...
class CostumeState extends MusicBeatState
{
	var CharacterList:Array<CostumeName> = [
		FEVER, TEASAR, FEVER_NUN, FEVER_CASUAL, MONGUS, MTALE, BIRTHDAY_BUILD, FEVER_MINUS, SOULSPLIT, DOODLE, CEABUN, FLU, CLASSIC, MCDIETIS, SKELLY,
		SHELTON, CEDAR, TANNER, FEVER_ISO, FEVER_COAT
	];
