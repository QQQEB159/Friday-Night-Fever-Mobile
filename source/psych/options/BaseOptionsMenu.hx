...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	private var grpOptions:FlxTypedGroup<psych.Alphabet>;
	...
	public function new()
	{
		...
		grpOptions = new FlxTypedGroup<psych.Alphabet>();
		add(grpOptions);
		...
		var titleText:psych.Alphabet = new psych.Alphabet(75, 40, title, true);
		...
		{
			var optionText:psych.Alphabet = new psych.Alphabet(290, 260, optionsArray[i].name, false);
